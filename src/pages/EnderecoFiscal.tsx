...
import { Building, CheckCircle, ArrowLeft, MessageCircle } from "lucide-react";
...
const EnderecoFiscal = () => {
  ...
  const benefits = [
    "Endereço fiscal com localização estratégica",
    "Recebimento de correspondências e encomendas",
    "Mais credibilidade e profissionalismo para sua empresa", 
    "Atendimento profissional na recepção",
    "Abertura e/ou mudança de endereço sem burocracia",
    "Todos nossos serviços com valores diferenciados"
  ];
  ...
  const steps = [
    ...
    { step: 4, title: "Ativação", description: "Seu endereço fiscal está pronto para uso!" }
  ];
      ...
      <main className="pt-20">
        ...
        <section className="py-16 bg-gradient-to-r from-brand-blue to-brand-light-blue text-white">
          <div className="container mx-auto px-4">
            ...
            <div className="flex items-center mb-6">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold">Endereço Fiscal</h1>
            </div>
        ...
        <section className="py-16 bg-gradient-to-r from-brand-green to-brand-light-blue text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-bold mb-6">Pronto para ter seu endereço fiscal?</h2>
